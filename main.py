...
logger.info("Prompt tokens:", usage.prompt_tokens)
logger.info("Reasoning tokens:", usage.reasoning_tokens)
logger.info("Text tokens:", usage.text_tokens)
logger.info("Benchmark cost:", usage.total_cost_dollar)
